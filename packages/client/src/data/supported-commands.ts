...
export const SUPPORTED_VIM_COMMANDS: Record<string, VimCommand> = {
  ...
  '_': { description: 'Move to first non-blank character (like ^)', category: 'line-movement' },
  ...
  'Ctrl+u': { description: 'Scroll half page up (alt notation)', category: 'vertical-movement' },
  'Ctrl+d': { description: 'Scroll half page down (alt notation)', category: 'vertical-movement' },
  ...
  'dw': { description: 'Delete to next word start', category: 'operator-combos' },
  'dW': { description: 'Delete to next WORD start', category: 'operator-combos' },
  'de': { description: 'Delete to word end', category: 'operator-combos' },
  'db': { description: 'Delete to previous word start', category: 'operator-combos' },
  'dj': { description: 'Delete current and next line', category: 'operator-combos' },
  'dk': { description: 'Delete current and previous line', category: 'operator-combos' },
  'cw': { description: 'Change to next word start', category: 'operator-combos' },
  'cW': { description: 'Change to next WORD start', category: 'operator-combos' },

  'diw': { description: 'Delete inside word', category: 'operator-text-objects' },
  'daw': { description: 'Delete around word', category: 'operator-text-objects' },
  'ciw': { description: 'Change inside word', category: 'operator-text-objects' },
  'caw': { description: 'Change around word', category: 'operator-text-objects' },
  'dip': { description: 'Delete inside paragraph', category: 'operator-text-objects' },
  'dap': { description: 'Delete around paragraph', category: 'operator-text-objects' },
  'cip': { description: 'Change inside paragraph', category: 'operator-text-objects' },

  'di(': { description: 'Delete inside parentheses', category: 'operator-text-objects' },
  'da(': { description: 'Delete around parentheses', category: 'operator-text-objects' },
  'ci(': { description: 'Change inside parentheses', category: 'operator-text-objects' },
  'ca(': { description: 'Change around parentheses', category: 'operator-text-objects' },
  'di{': { description: 'Delete inside curly braces', category: 'operator-text-objects' },
  'da{': { description: 'Delete around curly braces', category: 'operator-text-objects' },
  'ci{': { description: 'Change inside curly braces', category: 'operator-text-objects' },
  'ca{': { description: 'Change around curly braces', category: 'operator-text-objects' },
  'di[': { description: 'Delete inside square brackets', category: 'operator-text-objects' },
  'da[': { description: 'Delete around square brackets', category: 'operator-text-objects' },
  'ci[': { description: 'Change inside square brackets', category: 'operator-text-objects' },
  'ca[': { description: 'Change around square brackets', category: 'operator-text-objects' },

  'di"': { description: 'Delete inside double quotes', category: 'operator-text-objects' },
  'da"': { description: 'Delete around double quotes', category: 'operator-text-objects' },
  'ci"': { description: 'Change inside double quotes', category: 'operator-text-objects' },
  'ca"': { description: 'Change around double quotes', category: 'operator-text-objects' },
  "di'": { description: 'Delete inside single quotes', category: 'operator-text-objects' },
  "da'": { description: 'Delete around single quotes', category: 'operator-text-objects' },
  "ci'": { description: 'Change inside single quotes', category: 'operator-text-objects' },
  "ca'": { description: 'Change around single quotes', category: 'operator-text-objects' },
