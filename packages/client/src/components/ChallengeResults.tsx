...
export function ChallengeResults({
  ...
  useEffect(() => {
    if (!result.timedOut && !isPractice && !isRetry) {
      confetti({
        particleCount: 100,
        spread: 70,
        origin: { y: 0.6 }
  ...
  }, [result.totalScore, result.timedOut, isPractice, isRetry])
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 items-start p-6 bg-gray-900 rounded-xl border border-gray-700 shadow-2xl w-full">
      ...
      <div className="flex-1 w-full flex flex-col justify-between h-full">
        ...
        <div className="flex flex-col w-full gap-3 mt-auto">
          ...
          <div className="flex gap-3">
            ...
            >
              Retry
              <kbd className="text-xs bg-gray-600 px-1.5 py-0.5 rounded font-mono text-gray-200">r</kbd>
            </button>
            <button
              onClick={onBack}
            ...
            >
              Back
              <kbd className="text-xs bg-gray-700 px-1.5 py-0.5 rounded font-mono text-gray-200">b</kbd>
            </button>
          </div>
        </div>
      </div>
