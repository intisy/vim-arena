...
export default function LessonsPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--theme-background)] p-6 md:p-10">
      <div className="max-w-5xl mx-auto">
        <div className="mb-10">
          <Link
            to="/"
            className="text-sm text-[var(--theme-muted-foreground)] hover:text-[var(--theme-foreground)] transition-colors font-mono"
          >
            &larr; Back to Home
          </Link>
          <h1 className="text-4xl font-bold text-[var(--theme-foreground)] mt-4 mb-2">Lessons</h1>
